...
const db = mysql.createPool({
  host: 'mariadb', // the host name MYSQL_DATABASE: node_mysql
  user: 'user1', // database user MYSQL_USER: MYSQL_USER
  password: 'master', // database user password MYSQL_PASSWORD: MYSQL_PASSWORD
  database: 'test' // database name MYSQL_HOST_IP: mysql_db
})
